...
import { createPharmacy } from "@/actions/pharmacies/createpharmacy"
...
export default function CreatePharmacyForm({
  ...
  return (
    <section className={cn("flex flex-col gap-6", className)}>
      ...
      >
        {/* ── Pharmacy Details ── */}
        <h2 className={sectionTitleClass}>Pharmacy Details</h2>
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="pharmacyLicenseNumber" className={labelClass}>
